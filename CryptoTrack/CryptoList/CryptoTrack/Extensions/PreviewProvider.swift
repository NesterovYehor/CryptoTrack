...
class DeveloperPreview{
    ...
    let stat1 =  Statistic(title: "Market Cap", value: "$2.17Bn", percentageChange: 25.67)
    let stat2 =  Statistic(title: "Total Valuem", value: "$7.32Tr")
    let stat3 =  Statistic(title: "Portfolio Value", value: "$175.59k", percentageChange: -44.82)
